            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Event Managers</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Event Managers</a></li>
                            <li class="breadcrumb-item active">View Event Managers</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title">Event Manager Accounts</h3>
                                </div>
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a style="background: #ea7127;border-color:#ea7127 " href="/admin/account/eventmanager/create" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="viewStudents" class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        ResultSet rs = mDAO.getAllEventManager();
                                        int count = 1;
                                        while (rs.next()) {%> 
                                    <tr>
                                        <td><%=count++%></td>
                                        <td><%=rs.getString("StaffNumber")%></td>
                                        <td><a href="/admin/account/eventmanager/detail/<%=rs.getInt("ManagerProfileID")%>" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="${pageContext.request.contextPath}/assets/img/avatar/<%=rs.getString("Avatar")%>" alt="Avatar"></a><%=rs.getString("FirstName") + " " + rs.getString("LastName")%></td>
