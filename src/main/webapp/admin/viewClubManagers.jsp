                            ...
                            <table id="viewStudents" class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/admin/account/clubmanager/detail/<%=rs.getInt("ManagerProfileID")%>"><button class="mb-2 mr-2 btn-icon btn-pill btn btn-outline-primary"><i class="feather-edit-3"></i>Detail</button></a></td>
                                    </tr>
                                    <%}
                                    %>
                                </tbody>
