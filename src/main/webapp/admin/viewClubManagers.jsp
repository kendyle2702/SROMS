                            ...
                            <table id="viewStudents" class="table table-hover table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/admin/account/clubmanager/detail/<%=rs.getInt("ManagerProfileID")%>" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="${pageContext.request.contextPath}/assets/img/avatar/<%=rs.getString("Avatar")%>" alt="Avatar"></a><%=rs.getString("LastName") + " " + rs.getString("FirstName")%></td>
