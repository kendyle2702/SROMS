            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Add Club Manager</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Club Manager</a></li>
                            <li class="breadcrumb-item active">Add Club Manager</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card comman-shadow">
                    <div class="card-body">
                        <form id="formCreateClubManager" action="${pageContext.request.contextPath}/upload/profile/create" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title student-info">Club Manager Information</h5>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input id="experience" name="experience" class="form-control" type="text" placeholder="Enter Experience">
                                        <div class="message"></div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                ...
                                <input type="hidden" name="createClubManager" value="createClubManager">
                                <div class="col-12">
