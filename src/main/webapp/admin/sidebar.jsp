    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu <%=(session.getAttribute("tabId").equals(4)) || (session.getAttribute("tabId").equals(5)) || (session.getAttribute("tabId").equals(11)) ? "active" : ""%>">
                    <a href="#"><i class="feather-user"></i> <span class="title">Event Manager</span> <span class="menu-arrow"></span></a>
                    <ul>
                        <li><a href="/admin/account/eventmanager" class="<%=(session.getAttribute("tabId").equals(4)) || (session.getAttribute("tabId").equals(11)) ? "active subdrop" : ""%>">View Accounts</a></li>
                        <li><a href="/admin/account/eventmanager/create" class="<%=(session.getAttribute("tabId").equals(5) ? "active subdrop" : "")%>">Add Account</a></li>
                    </ul>
                </li>
                <li class="submenu <%=session.getAttribute("tabId").equals(6) || session.getAttribute("tabId").equals(7) || session.getAttribute("tabId").equals(12) ? "active" : ""%>">
                    <a href="#"><i class="feather-user"></i> <span class="title">Club Manager</span> <span class="menu-arrow"></span></a>
                    <ul>
                        <li><a href="/admin/account/clubmanager" class="<%=session.getAttribute("tabId").equals(6) || session.getAttribute("tabId").equals(12) ? "active subdrop" : ""%>">View Accounts</a></li>
