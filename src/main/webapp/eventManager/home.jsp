                                                    ...
                                                    <%@page import="Models.Event" %>
                                                        <%@page import="java.util.List" %>
                                                            <%@page import="DAOs.EventDAO" %>
                                                                        ...
                                                                        <%UserProfile user=(UserProfile)
                                                                            ...
                                                                            <div class="page-header">
                                                                                ...
                                                                                <div style="margin-top: 30px"
                                                                                    class="card flex-fill comman-shadow">
                                                                                    <div class="card-header">
                                                                                        <div
                                                                                            ...
                                                                                            <div class="col-8">
                                                                                                <ul
                                                                                                    class="chart-list-out">
                                                                                                    <li
                                                                                                        class="lesson-view-all">
                                                                                                        <a
                                                                                                            href="/eventmanager/news/view">View
                                                                                                            All</a></li>
                                                                                                </ul>
                                                                                            </div>
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <a style="background: #ea7127;border-color:#ea7127"
                                                                                                                        ...
                                                                                                                        data-bs-target="#news_detail<%= latestNews.getNewsID()%>"
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            <div
                                                                                                ...
                                                                                                <div class="db-info">
                                                                                                    <h6>Total Event Is
                                                                                                        Not Started</h6>
                                                                                                    <h3>${sessionScope.totalEventNotStarted}
                                                                                                    </h3>
                                                                                                </div>
                                                                                                <div class="db-icon">
                                                                                                    <img src="${pageContext.request.contextPath}/assets/img/icons/teacher-icon-01.svg"
                                                                                                        alt="Dashboard Icon">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            <div
                                                                                                ...
                                                                                                <div class="db-info">
                                                                                                    <h6>Total Event
                                                                                                        Finished</h6>
                                                                                                    <h3>${sessionScope.totalEventTook}
                                                                                                    </h3>
                                                                                                </div>
                                                                                                <div class="db-icon">
                                                                                                    <img src="${pageContext.request.contextPath}/assets/img/icons/dash-icon-01.svg"
                                                                                                        alt="Dashboard Icon">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="card-body">
                                                                                            <div
                                                                                                ...
                                                                                                <div class="db-info">
                                                                                                    <h6>Total Cost Of
                                                                                                        Events</h6>
                                                                                                    <h3>${sessionScope.totalcost}
                                                                                                        VND</h3>
                                                                                                </div>
                                                                                                <div class="db-icon">
                                                                                                    <img src="${pageContext.request.contextPath}/assets/img/icons/teacher-icon-02.svg"
                                                                                                        alt="Dashboard Icon">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                            ...
                                                                            <div class="modal custom-modal fade"
                                                                                id="news_detail<%= latestNews.getNewsID()%>"
                                                                                aria-hidden="true"
                                                                                style="display: none;">
                                                                                <div
                                                                ...
                                                                <% EventDAO eventDAO=new EventDAO(); List<Map<String,
                                                                    String>> listtop5 = eventDAO.getTop5Event();
                                                                    ArrayList<String> listName = new ArrayList<>();
                                                                            ArrayList<String> listTop5 = new ArrayList<>
                                                                                    ();
                                                                                    for (Map<String, String> list :
                                                                                        listtop5) {
                                                                                        for (Map.Entry<String, String>
                                                                                            entry : list.entrySet()) {
                                                                                            if
                                                                                            (entry.getKey().equals("EventName"))
                                                                                            {
