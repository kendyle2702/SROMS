        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class=" <%=(session.getAttribute("tabId").equals(12)) ? "active" : ""%>">
                    <a href="/eventmanager/events/eventswitingapprove"><i class=""></i><span>List Events Awaiting Approval</span></a>
                </li>
                <li class=" <%=(session.getAttribute("tabId").equals(11)) ? "active" : ""%>">
                    <a  href="/eventmanager/events/checkrequestcreateevent"><i class=""></i><span>Check Request Create Event</span></a>
                </li>
